...
def search_company_news(company_name: str, ts_code: str, market: str = "A股", industry: str = "") -> dict:
    """
    ...
    return provider.search_company(company_name, ts_code, market, industry)
